...
public class PegawaiController {
    ...
    public void insertPegawai(Pegawai p) {
        ...
        try {
            if (p.getId_pegawai() > 0) {
                ...
                this.koneksi.ManipulasiData("UPDATE FITRIARISQINAA_07032.PEGAWAI_07032 SET NAMA_PEGAWAI = '" + p.getNama_Pegawai() + "', ALAMAT ='" + p.getAlamat() + "', ID_USER ='" + String.valueOf(Data.userlLogin.getId_user()) + "' WHERE ID_PEGAWAI =" + p.getId_pegawai());
            } else {
                System.out.println("INSERT PEGAWAI");
                this.koneksi.ManipulasiData("INSERT INTO FITRIARISQINAA_07032.PEGAWAI_07032 (ID_PEGAWAI, ID_USER, NAMA_PEGAWAI, ALAMAT) VALUES (ID_PEGAWAI.NEXTVAL, '" + String.valueOf(Data.userlLogin.getId_user()) + "', '" + p.getNama_Pegawai() + "', '" + p.getAlamat() + "')");
            }
        } catch (Exception e) {
    ...
    public void deletePegawai(int idPegawai) {
        try {
            this.koneksi.ManipulasiData("DELETE FITRIARISQINAA_07032.PEGAWAI_07032 WHERE ID_PEGAWAI=" + idPegawai);
        } catch (Exception e) {
            System.out.println(e);
        }
    }
