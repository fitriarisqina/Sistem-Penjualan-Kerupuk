...
public class TransaksiView extends javax.swing.JFrame {
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            if (p.getId_produk() > 0) {
                Produk prod = produkCtrl.getDataproduk(p).get(0);
                String jumlahP = tfJumlah.getText();

                if (!jumlahP.equals("")) {
                    int stokProduk = Integer.parseInt(tfStok.getText().toString());
                    double totalHarga = prod.getHarga() * Integer.parseInt(jumlahP);
                    ...
                    detail.setQtyProduk(Integer.parseInt(jumlahP));
                    ...
                    // jmlprodukkembali
                    jmlProdukKembali += (stokProduk - Integer.parseInt(jumlahP));
                } else {
    ...
    private void btnPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesanActionPerformed
         ...
         try {
            ...
            if(tfTglMasuk.getText().equals("")){
                JOptionPane.showMessageDialog(null, " Tanggal masuk belum ditambahkan,tambahkan tanggal masuk terlebih dahulu !");
            }else if(tfTglKeluar.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Tanggal keluar belum ditambahkan, tambahkan tanggal keluar terlebih dahulu !");
            }else if(totalPesan < 1){
